...
import CommentsSend from "./components/CommentsSend/CommentsSend";
        ...
        <div>
            ...
            <Container>
                <Row>
                    ...
                    <Col lg="4"><RigthMenu leftContentCategoryForm={leftContentCategoryForm}
                                           rightContentCategoryForm={rightContentCategoryForm}
                                           contentSideWidget={contentSideWidget}/></Col>
                </Row>
            </Container>
<Comments/>
